...
namespace uComponents.DataTypes.MultipleTextstring
{
	...
	public class MultipleTextstringControl : PlaceHolder
	{
		...
		/// </summary>
		public const string CssResourcePath = "uComponents.Legacy.DataTypes.MultipleTextstring.MultipleTextstring.css";

		/// <summary>
		/// Embedded resource path for the JavaScript file.
		/// </summary>
		public const string JavaScriptResourcePath = "uComponents.Legacy.DataTypes.MultipleTextstring.MultipleTextstring.js";
