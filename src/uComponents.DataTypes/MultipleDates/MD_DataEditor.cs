...
namespace uComponents.DataTypes.MultipleDates
{
	...
	public class MD_DataEditor : CompositeControl
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			this.RegisterEmbeddedClientResource("uComponents.DataTypes.MultipleDates.scripts.main.js", ClientDependency.Core.ClientDependencyType.Javascript);
			this.RegisterEmbeddedClientResource("uComponents.DataTypes.MultipleDates.css.MultipleDates.css", ClientDependency.Core.ClientDependencyType.Css);
		}
